...
run_list 'recipe[chef_client_updater]', 'recipe[runstatus_handler]', 'recipe[copy_resource_tracker]', 'recipe[disable_password_expiry]', 'recipe[upgrade_mobiledgex_package]'

# Specify a custom source for a single cookbook:
cookbook 'chef_client_updater', '= 3.11.0'
cookbook 'runstatus_handler', '= 1.0.0'
cookbook 'copy_resource_tracker', '= 1.0.1'
cookbook 'disable_password_expiry', '= 1.0.0'
