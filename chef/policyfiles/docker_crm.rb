...
run_list 'recipe[runstatus_handler]', 'recipe[run_cmd]', 'recipe[setup_infra]', 'recipe[preflight_crm_checks]', 'recipe[run_diagnostics]', 'recipe[setup_services::docker]', 'recipe[set_security_policies]'
...
override['main']['edgeCloudVersion'] = '2021-08-14-6'
