...
run_list 'chef_client_updater::default', 'recipe[runstatus_handler]', 'recipe[run_cmd]', 'recipe[setup_infra]', 'recipe[preflight_crm_checks]', 'recipe[run_diagnostics]', 'recipe[setup_services::k8s]', 'recipe[set_security_policies]', 'recipe[setup_teleport]', 'recipe[copy_third_party_notice]'
