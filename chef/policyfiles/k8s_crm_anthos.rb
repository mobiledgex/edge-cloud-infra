...
run_list 'chef_client_updater::default', 'recipe[runstatus_handler]', 'recipe[run_cmd]', 'recipe[setup_infra]', 'recipe[preflight_crm_checks]', 'recipe[setup_vault_ssh]', 'recipe[run_diagnostics]', 'recipe[setup_services_anthos::k8s]', 'recipe[set_security_policies]', 'recipe[copy_third_party_notice]'

# Specify a custom source for a single cookbook:
cookbook 'runstatus_handler', '= 1.0.0'
cookbook 'setup_infra', '= 1.0.0'
cookbook 'preflight_crm_checks', '= 1.0.0'
cookbook 'setup_vault_ssh', '= 1.0.3'
cookbook 'docker', '= 7.7.0'
cookbook 'setup_services_anthos', '= 1.9.10'
