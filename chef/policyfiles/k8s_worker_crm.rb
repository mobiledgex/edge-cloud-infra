...
run_list 'chef_client_updater::default', 'recipe[runstatus_handler]', 'recipe[setup_infra]', 'recipe[preflight_crm_checks]',  'recipe[setup_services::k8s-worker]', 'recipe[chef_client_updater]', 'recipe[set_security_policies]' 
