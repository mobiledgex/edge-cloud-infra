...
func (a *AwsEc2Platform) InitApiAccessProperties(ctx context.Context, accessApi platform.AccessApi, vars map[string]string, stage vmlayer.ProviderInitStage) error {
	...
	if stage == vmlayer.ProviderInitPlatformStartCrmActive || stage == vmlayer.ProviderInitPlatformStartShepherd || stage == vmlayer.ProviderInitCreateCloudletDirect || stage == vmlayer.ProviderInitDeleteCloudlet {
	...
	if stage == vmlayer.ProviderInitPlatformStartCrmActive || stage == vmlayer.ProviderInitPlatformStartShepherd {
