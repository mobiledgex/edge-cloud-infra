...
func (v *VSpherePlatform) AddAppImageIfNotPresent(ctx context.Context, localImageName string, app *edgeproto.App, flavor string, updateCallback edgeproto.CacheUpdateCallback) error {
	...
	filePath, err := vmlayer.DownloadVMImage(ctx, v.vmProperties.CommonPf.PlatformConfig.AccessApi, localImageName, app.ImagePath, md5Sum)
	if err != nil {
		return err
	}
