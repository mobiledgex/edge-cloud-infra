...
def get_pods(namespace):
    cmd = "kubectl --kubeconfig=/tmp/defaultmtclust.tmus.kubeconfig get pods -n "+namespace+" -o wide --no-headers=true"
    stream = os.popen(cmd)
...
def get_ping_cmd(src_namespace, src_pod_name, dst_ip):
    ...
    return "kubectl --kubeconfig=/tmp/defaultmtclust.tmus.kubeconfig exec -it -n " + src_namespace + " " + src_pod_name + " -- ping " + dst_ip + " -c 3 -i 0.5 -w 2 -W 3"
