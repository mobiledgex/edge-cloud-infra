...
def getAppClusterInsts():
        ...
        p = subprocess.Popen([Edgectl+" controller ShowAppInst operator=\""+Operator+"\"   cloudlet=\""+Cloudlet+"\""], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True, universal_newlines=True)
        ...
        p = subprocess.Popen([Edgectl+" controller ShowClusterInst operator=\""+Operator+"\" cloudlet=\""+Cloudlet+"\""], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True, universal_newlines=True)
