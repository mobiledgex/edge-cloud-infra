...
func (s *Client) DeleteSelfFederator(uri string, token string, in *ormapi.FederatorRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) ShowFederator(uri string, token string, in *ormapi.FederatorRequest) ([]ormapi.FederatorRequest, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("ShowFederator")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) AddPartnerFederator(uri string, token string, in *ormapi.FederatorRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("AddPartnerFederator")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) RemovePartnerFederator(uri string, token string, in *ormapi.FederatorRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("RemovePartnerFederator")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) CreateSelfFederatorZone(uri string, token string, in *ormapi.FederatorZoneDetails) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) DeleteSelfFederatorZone(uri string, token string, in *ormapi.FederatorZoneDetails) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) ShareSelfFederatorZone(uri string, token string, in *ormapi.FederatorZoneRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) UnshareSelfFederationZone(uri string, token string, in *ormapi.FederatorZoneRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("UnshareSelfFederationZone")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) RegisterPartnerFederationZone(uri string, token string, in *ormapi.FederatorZoneRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("RegisterPartnerFederationZone")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) DeRegisterPartnerFederationZone(uri string, token string, in *ormapi.FederatorZoneRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	...
	apiCmd := ormctl.MustGetCommand("DeRegisterPartnerFederationZone")
	s.ClientRun.Run(apiCmd, &rundata)
	if rundata.RetError != nil {
		return nil, rundata.RetStatus, rundata.RetError
	}
...
func (s *Client) ShowFederationZone(uri string, token string, in *ormapi.FederatorZoneDetails) ([]ormapi.FederatorZoneDetails, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
	var out []ormapi.FederatorZoneDetails
	rundata.Out = &out
...
func (s *Client) CreateFederation(uri string, token string, in *ormapi.FederationRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) DeleteFederation(uri string, token string, in *ormapi.FederationRequest) (*ormapi.Result, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
...
func (s *Client) ShowFederation(uri string, token string, in *ormapi.FederationRequest) ([]ormapi.Federation, int, error) {
	rundata := RunData{}
	rundata.Uri = uri
	rundata.Token = token
	rundata.In = in
