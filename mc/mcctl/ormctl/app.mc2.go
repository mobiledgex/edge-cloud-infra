...
var FindCloudletsForAppDeploymentCmd = &ApiCommand{
	Name:         "FindCloudletsForAppDeployment",
	Use:          "findcloudletsfordeployment",
	Short:        "Find cloudlets that can support Apps Detault Flavor",
	RequiredArgs: "region " + strings.Join(DeploymentCloudletRequestRequiredArgs, " "),
	...
	Path:         "/auth/ctrl/FindCloudletsForAppDeployment",
	ProtobufApi:  true,
}
...
var AppApiCmds = []*ApiCommand{
	...
	FindCloudletsForAppDeploymentCmd,
}
...
var DeploymentCloudletRequestAliasArgs = []string{
	"key.organization=deploymentcloudletrequest.key.organization",
	"key.name=deploymentcloudletrequest.key.name",
	"key.version=deploymentcloudletrequest.key.version",
	"app.fields=deploymentcloudletrequest.app.fields",
	"app.key.organization=deploymentcloudletrequest.app.key.organization",
	"app.key.name=deploymentcloudletrequest.app.key.name",
	"app.key.version=deploymentcloudletrequest.app.key.version",
	...
	"testdeploynow=deploymentcloudletrequest.testdeploynow",
}
