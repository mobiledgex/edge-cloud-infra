...
var AppComments = map[string]string{
	...
	"skiphcports":             "Comma separated list of protocol:port pairs that we should not run health check on Should be configured in case app does not always listen on these ports Numerical values must be decimal format. i.e. tcp:80,udp:10002,http:443",
}
