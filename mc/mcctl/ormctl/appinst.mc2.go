...
var AppInstAliasArgs = []string{
	...
	"mappedports:#.skiphealthcheck=appinst.mappedports:#.skiphealthcheck",
...
var AppInstComments = map[string]string{
	...
	"mappedports:#.skiphealthcheck":  "Proxy health check for this port",
	"flavor":                         "Flavor name",
