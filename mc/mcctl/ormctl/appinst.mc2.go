...
var AppInstLatencyAliasArgs = []string{
	...
	"samples:#.value=appinstlatency.samples:#.value",
	"samples:#.loc.latitude=appinstlatency.samples:#.loc.latitude",
	"samples:#.loc.longitude=appinstlatency.samples:#.loc.longitude",
	"samples:#.loc.horizontalaccuracy=appinstlatency.samples:#.loc.horizontalaccuracy",
	"samples:#.loc.verticalaccuracy=appinstlatency.samples:#.loc.verticalaccuracy",
	"samples:#.loc.altitude=appinstlatency.samples:#.loc.altitude",
	"samples:#.loc.course=appinstlatency.samples:#.loc.course",
	"samples:#.loc.speed=appinstlatency.samples:#.loc.speed",
	"samples:#.loc.timestamp.seconds=appinstlatency.samples:#.loc.timestamp.seconds",
	"samples:#.loc.timestamp.nanos=appinstlatency.samples:#.loc.timestamp.nanos",
	"samples:#.sessioncookie=appinstlatency.samples:#.sessioncookie",
	"samples:#.datanetworktype=appinstlatency.samples:#.datanetworktype",
	"samples:#.timestamp.seconds=appinstlatency.samples:#.timestamp.seconds",
	"samples:#.timestamp.nanos=appinstlatency.samples:#.timestamp.nanos",
	"samples:#.tags=appinstlatency.samples:#.tags",
}
...
var AppInstLatencySpecialArgs = map[string]string{
	"appinstlatency.samples:#.tags": "StringToString",
}
