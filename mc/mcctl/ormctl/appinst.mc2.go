...
var CreateAppInstCmd = &ApiCommand{
	...
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,UniqueId,UpdateMultiple,ForceUpdate,PowerState",
...
var DeleteAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,UniqueId,PowerState",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var RefreshAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,UniqueId,Flavor,AutoClusterIpAccess,Configs,PowerState,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var UpdateAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,UniqueId,Flavor,AutoClusterIpAccess,UpdateMultiple,ForceUpdate,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var ShowAppInstCmd = &ApiCommand{
	...
	SpecialArgs:  &AppInstSpecialArgs,
	Comments:     addRegionComment(AppInstComments),
	NoConfig:     "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,UniqueId",
	ReqData:      &ormapi.RegionAppInst{},
