...
var CreateAppInstCmd = &ApiCommand{
	...
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,UpdateMultiple,ForceUpdate,PowerState",
...
var DeleteAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,PowerState",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var RefreshAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,Flavor,AutoClusterIpAccess,Configs,PowerState,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var UpdateAppInstCmd = &ApiCommand{
	...
	SpecialArgs:          &AppInstSpecialArgs,
	Comments:             addRegionComment(AppInstComments),
	NoConfig:             "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel,Flavor,AutoClusterIpAccess,UpdateMultiple,ForceUpdate,HealthCheck,SharedVolumeSize,VmFlavor",
	ReqData:              &ormapi.RegionAppInst{},
	ReplyData:            &edgeproto.Result{},
...
var ShowAppInstCmd = &ApiCommand{
	...
	SpecialArgs:  &AppInstSpecialArgs,
	Comments:     addRegionComment(AppInstComments),
	NoConfig:     "CloudletLoc,Uri,MappedPorts,Liveness,CreatedAt,Status,Revision,Errors,RuntimeInfo,VmFlavor,ExternalVolumeSize,AvailabilityZone,State,UpdatedAt,OptRes,SharedVolumeSize,AutoClusterIpAccess,InternalPortToLbIp,UniqueId,DnsLabel",
	ReqData:      &ormapi.RegionAppInst{},
...
var AppInstAliasArgs = []string{
	...
	"federated-org=appinst.key.clusterinstkey.cloudletkey.federatedorganization",
...
var AppInstLatencyAliasArgs = []string{
	...
	"federated-org=appinstlatency.key.clusterinstkey.cloudletkey.federatedorganization",
