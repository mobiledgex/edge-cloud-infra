...
var AutoProvInfoComments = map[string]string{
	...
	"maintenancestate": "failover result state, one of NormalOperation, MaintenanceStart, FailoverRequested, FailoverDone, FailoverError, MaintenanceStartNoFailover, CrmRequested, CrmUnderMaintenance, CrmError, UnderMaintenance",
