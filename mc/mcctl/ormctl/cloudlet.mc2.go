...
var CloudletAliasArgs = []string{
	...
	"config.federationaddr=cloudlet.config.federationaddr",
	"config.federationname=cloudlet.config.federationname",
...
var CloudletComments = map[string]string{
	...
	"config.federationaddr":                "Federation address",
	"config.federationname":                "Federation name",
