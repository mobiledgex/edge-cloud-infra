...
var CloudletInfoAliasArgs = []string{
	...
	"flavors:#.deprecated=cloudletinfo.flavors:#.deprecated",
	...
	"deprecatedflavors:#.name=cloudletinfo.deprecatedflavors:#.name",
	"deprecatedflavors:#.vcpus=cloudletinfo.deprecatedflavors:#.vcpus",
	"deprecatedflavors:#.ram=cloudletinfo.deprecatedflavors:#.ram",
	"deprecatedflavors:#.disk=cloudletinfo.deprecatedflavors:#.disk",
	"deprecatedflavors:#.propmap=cloudletinfo.deprecatedflavors:#.propmap",
	"deprecatedflavors:#.deprecated=cloudletinfo.deprecatedflavors:#.deprecated",
}
var CloudletInfoComments = map[string]string{
	...
	"deprecatedflavors:#.deprecated": "true if this infra flavor has been deleted while in use",
}
var CloudletInfoSpecialArgs = map[string]string{
	"cloudletinfo.deprecatedflavors:#.propmap": "StringToString",
