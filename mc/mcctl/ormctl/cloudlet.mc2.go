...
var CloudletComments = map[string]string{
	...
	"platformtype":                        "Platform type, one of PlatformTypeFake, PlatformTypeFakeinfra, PlatformTypeDind, PlatformTypeOpenstack, PlatformTypeAzure, PlatformTypeGcp, PlatformTypeMexdind",
