...
var NoticeAliasArgs = []string{
	...
	"any.typeurl=notice.any.typeurl",
	"any.value=notice.any.value",
	"wantobjs=notice.wantobjs",
	"filtercloudletkey=notice.filtercloudletkey",
	"span=notice.span",
...
var NoticeSpecialArgs = map[string]string{
	"notice.tags":     "StringToString",
	"notice.wantobjs": "StringArray",
}
