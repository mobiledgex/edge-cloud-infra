...
func init() {
	cmds := []*ApiCommand{&ApiCommand{
		...
		AliasArgs:    strings.Join(append(AppUsageAliasArgs, MetricsCommonAliasArgs...), " "),
		...
		AliasArgs:    strings.Join(append(ClusterUsageAliasArgs, MetricsCommonAliasArgs...), " "),
		...
		AliasArgs:    strings.Join(append(CloudletPoolUsageAliasArgs, MetricsCommonAliasArgs...), " "),
