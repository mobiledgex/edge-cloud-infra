...
func GetUserCommand() *cobra.Command {
	cmds := []*cli.Command{&cli.Command{
		...
		OptionalArgs:   "nickname familyname givenname callbackurl enabletotp settings",
		AliasArgs:      "name=user.name email=user.email nickname=user.nickname familyname=user.familyname givenname=user.givenname password=user.passhash callbackurl=verify.callbackurl enabletotp=user.enabletotp setings=user.settings",
		...
		Use:          "update",
		OptionalArgs: "email nickname familyname givenname callbackurl enabletotp settings",
		AliasArgs:    "email=user.email nickname=user.nickname familyname=user.familyname givenname=user.givenname callbackurl=verify.callbackurl enabletotp=user.enabletotp settings=user.settings",
		ReqData:      &ormapi.CreateUser{},
		ReplyData:    &ormapi.UserResponse{},
