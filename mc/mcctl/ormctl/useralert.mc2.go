...
var UserAlertAliasArgs = []string{
	...
	"cpuutilizationlimit=useralert.cpuutilizationlimit",
	"memutilizationlimit=useralert.memutilizationlimit",
	"diskutilizationlimit=useralert.diskutilizationlimit",
...
var UserAlertComments = map[string]string{
	...
	"name":                 "Alert name",
	"cpuutilizationlimit":  "CPU utiliztion rate(percentage) across all nodes",
