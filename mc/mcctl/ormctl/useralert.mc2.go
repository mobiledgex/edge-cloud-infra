...
var UserAlertAliasArgs = []string{
	...
	"cpulimit=useralert.cpulimit",
	"memlimit=useralert.memlimit",
	"disklimit=useralert.disklimit",
	"activeconnlimit=useralert.activeconnlimit",
	"severity=useralert.severity",
	"triggertime=useralert.triggertime",
