...
var VMPoolComments = map[string]string{
	...
	"vms:#.flavor.deprecated":  "true if the infra flavor has been deleted while in use",
...
var VMPoolMemberComments = map[string]string{
	...
	"vm.flavor.deprecated":  "true if the infra flavor has been deleted while in use",
	"crmoverride":           "Override actions to CRM, one of NoOverride, IgnoreCrmErrors, IgnoreCrm, IgnoreTransientState, IgnoreCrmAndTransientState",
}
