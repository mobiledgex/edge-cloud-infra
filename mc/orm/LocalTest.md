...
http --verify=false --auth-type=jwt --auth=$SUPERPASS POST https://127.0.0.1:9900/api/v1/auth/metrics/cloudlet <<< '{"region":"local","cloudlet":{"operator_key":{"name":"TDG"},"name":"lev-frankfurt"},"selector":"ipusage","last":2}'
http --verify=false --auth-type=jwt --auth=$SUPERPASS POST https://127.0.0.1:9900/api/v1/auth/metrics/clientapiusage <<< '{"region":"local","appinst":{"app_key":{"developer_key":{"name":"AcmeAppCo"},"name":"someapplication1","version":"1.0"}},"method":"FindCloudlet","selector":"api","last":2}'
```
