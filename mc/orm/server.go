...
func RunServer(config *ServerConfig) (retserver *Server, reterr error) {
	...
	auth.POST("/federation/update", UpdateFederation)
	auth.POST("/federation/delete", DeleteFederation)
	auth.POST("/federation/partner/add", AddFederationPartner)
	auth.POST("/federation/partner/remove", RemoveFederationPartner)
