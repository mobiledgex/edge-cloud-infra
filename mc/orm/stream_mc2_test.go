...
// This tests the user cannot modify the object because the obj belongs to
// an organization that the user does not have permissions for.
func badPermTestStreamObjApiClusterInstKey(t *testing.T, mcClient *mctestclient.Client, uri, token, region, org string, modFuncs ...func(*edgeproto.ClusterInstKey)) {
	badPermStreamClusterInst(t, mcClient, uri, token, region, org, modFuncs...)
}

// This tests the user can modify the object because the obj belongs to
// an organization that the user has permissions for.
func goodPermTestStreamObjApiClusterInstKey(t *testing.T, mcClient *mctestclient.Client, uri, token, region, org string, showcount int, modFuncs ...func(*edgeproto.ClusterInstKey)) {
...
// modifying obj1, and user with token2 who should have permissions for obj2.
// They should not have permissions to modify each other's objects.
func permTestStreamObjApiClusterInstKey(t *testing.T, mcClient *mctestclient.Client, uri, token1, token2, region, org1, org2 string, showcount int, modFuncs ...func(*edgeproto.ClusterInstKey)) {
	badPermTestStreamObjApiClusterInstKey(t, mcClient, uri, token1, region, org2, modFuncs...)
	badPermTestStreamObjApiClusterInstKey(t, mcClient, uri, token2, region, org1, modFuncs...)
	goodPermTestStreamObjApiClusterInstKey(t, mcClient, uri, token1, region, org1, showcount, modFuncs...)
	goodPermTestStreamObjApiClusterInstKey(t, mcClient, uri, token2, region, org2, showcount, modFuncs...)
}
