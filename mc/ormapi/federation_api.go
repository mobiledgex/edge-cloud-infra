...
type OPAppArtifactRequest struct {
	// required: true
	// request identifier
	RequestId string `json:"requestId"`
	// required: true
...
type OPArtifactMetadata struct {
	// enum: ADDED, REMOVED
...
type OPApplicationMetadata struct {
	// pattern: "^[a-z0-9]([a-z0-9]*[a-z0-9])?$"
	// minLength: 1, maxLength: 16
...
type OPApplicationAttributes struct {
...
type OPApplicationDeployment struct {
...
type OPApplicationExposedInterface struct {
	// pattern: "^[a-z0-9]([a-z0-9]*[a-z0-9])?$"
	// minLength: 1, maxLength: 16
...
type OPApplicationComputeResourceRequirement struct {
...
type OPApplicationInputParameter struct {
...
type OPApplicationPersistentVolume struct {
...
type OPApplicationComponent struct {
	// pattern: "^[a-z0-9]([a-z0-9]*[a-z0-9])?$"
	// minLength: 1, maxLength: 16
	...
	// Details of path/docker repository to get component image
	ComponentSource OPApplicationComponentSource `json:"componentSource"`
	// List of interfaces exposed by the application component
	ExposedInterfaces OPApplicationExposedInterface `json:"exposedInterfaces"`
	// Details about the minimum CPU, RAM and GPU required by the application"
	ComputeResourceRequirements []OPApplicationComputeResourceRequirement `json:"ComputeResourceRequirements"`
	// List of key value pairs that will be injected as environment variables in the Kubernetes pod created corresponding the component.
	InputParameters []OPApplicationInputParameter `json:"inputParameters"`
	// Details of persistent volumes required by the application component.
	PersistentVolume []OPApplicationPersistentVolume `json:"persistentVolume"`
}

// Details about application components, interfaces, executables etc.
type OPApplicationComponentDetail struct {
	// pattern: "^[a-z0-9]([a-z0-9]*[a-z0-9])?$"
	// minLength: 1, maxLength: 16
	...
	// Details about different modules of the application
	Components []OPApplicationComponent `json:"components"`
}

// Details about application components, application images, compute resources etc
type OPApplicationSpec struct {
	// Details about the terraform and ansible scripts associated with the application
	Deployment OPApplicationDeployment `json:"deployment"`
	// Details about application components, interfaces, executables etc
	ComponentDetails []OPApplicationComponentDetail `json:"componentdetails"`
}
...
type OPApplicationData struct {
	...
	HelmFileId string `json:"helmFileId"`
	// Application metadata details
	Metadata OPApplicationMetadata `json:"metadata"`
	// Parameters corresponding to the performance constraints, tenancy details etc
	Attributes OPApplicationAttributes `json:"attributes"`
	// default: "Enabled"
	// enum: "Enabled", "Disabled"
	// Define if application can be provisioned or not
	Provisioning string `json:"provisioning"`
	// Geographical location where application should be made available
	Regions []OPRegion `json:"regions"`
	// Details about application components, application images, compute resources etc
	Specification OPApplicationSpec `json:"specification"`
}
