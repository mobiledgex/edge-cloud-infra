...
func CreateRootLB(ctx context.Context, rootLB *MEXRootLB, vmspec *vmspec.VMCreationSpec, cloudletKey *edgeproto.CloudletKey, vmType DeploymentType, imgPath, imgVersion string, updateCallback edgeproto.CacheUpdateCallback) error {
	...
	if !found {
		...
		err = HeatCreateRootLBVM(ctx, rootLB.Name, stackName, imgName, vmspec, cloudletKey, updateCallback)
		if err != nil {
...
func SetupRootLB(
	...
	rootLBSpec *vmspec.VMCreationSpec, cloudletKey *edgeproto.CloudletKey,
	vmType DeploymentType, imgPath, imgVersion string,
