...
func CreateRootLB(rootLB *MEXRootLB, platformFlavor string, clusterKey *edgeproto.ClusterInstKey, clusterCache *edgeproto.ClusterInstInfoCache) error {
	...
	if found == 0 {
		...
		err := HeatCreateRootLBVM(rootLB.Name, rootLB.Name, platformFlavor, clusterKey, clusterCache)
		if err != nil {
...
func SetupRootLB(rootLBName string, createRootLBFlavor string, clusterKey *edgeproto.ClusterInstKey, clusterCache *edgeproto.ClusterInstInfoCache) error {
	...
	if err == nil && sd.Name == rootLBName {
		...
		err = CreateRootLB(rootLB, createRootLBFlavor, clusterKey, clusterCache)
		if err != nil {
