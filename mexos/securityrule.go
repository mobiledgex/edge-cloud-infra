...
func DeleteProxySecurityGroupRules(ctx context.Context, client pc.PlatformClient, name string, groupName string, ports []dme.AppPort, app *edgeproto.App, serverName string) error {
