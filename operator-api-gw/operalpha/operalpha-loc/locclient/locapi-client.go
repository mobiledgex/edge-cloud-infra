...
import (
	...
	"github.com/mobiledgex/edge-cloud-infra/operator-api-gw/operalpha/operalpha-loc/util"
...
func CallOPERALPHALocationVerifyAPI(locVerUrl string, lat, long float64, token string, tokSrvUrl string) dmecommon.LocationResult {
