...
variable "jaeger_domain_name" {
  default     = "jaeger-vcd.mobiledgex.net"
}

variable "esproxy_domain_name" {
  default     = "events-vcd.es.mobiledgex.net"
}

variable "alertmanager_domain_name" {
  default     = "alertmanager-vcd.mobiledgex.net"
}

variable "vault_a_domain_name" {
  default     = "vault-vcd-a.mobiledgex.net"
}

variable "vault_b_domain_name" {
  default     = "vault-vcd-b.mobiledgex.net"
}
